...
QMAKE    = /usr/bin/qmake
taglib.xcodeproj/project.pbxproj: taglib.pro  /usr/local/Qt4.5/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o taglib.xcodeproj/project.pbxproj taglib.pro
